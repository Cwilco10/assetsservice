...
import edu.iu.c322.assetmanagement.licensingservice.repository.AssetsRepository;
...
public class AssetsController {
    ...
    public AssetsController(AssetsRepository repository, OrganizationClient organizationClient) {
